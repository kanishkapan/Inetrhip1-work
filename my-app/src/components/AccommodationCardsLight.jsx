...
export default function AccommodationCardsLight() {
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-black">Accommodation</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="p-3">
            <h3 className="font-bold text-black text-base mb-1">Shinagawa Prince Hotel</h3>
            ...
            <div className="flex justify-between items-center">
              <div className="text-black text-sm font-medium">2 Nights</div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="p-3">
            <h3 className="font-bold text-black text-base mb-1">Mercure Tokyo Hotel</h3>
            <div className="text-gray-600 text-xs mb-1">
